...
fun TipTimeLayout() {
    ...
    var roundUp by remember { // Это переменная для компонуемого состояния Switch, а значением по умолчанию будет значение false.
 ...
 */
@VisibleForTesting //Это делает метод общедоступным, но указывает другим, что он доступен только в целях тестирования.
